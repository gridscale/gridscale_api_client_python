...
class Storage(object):
    ...
    def __init__(self, parent_uuid=None, labels=None, snapshots=None, object_uuid=None, relations=None, name=None, status=None, location_country=None, usage_in_minutes=None, location_uuid=None, change_time=None, storage_type=None, license_product_no=None, current_price=None, create_time=None, last_used_template=None, capacity=None, location_name=None, location_iata=None):  # noqa: E501
