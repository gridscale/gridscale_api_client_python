...
class MarketPlaceTemplateImport(object):
    ...
    def __init__(self, unique_hash=None):  # noqa: E501
        """MarketPlaceTemplateImport - a model defined in Swagger"""  # noqa: E501
    ...
    def unique_hash(self):
        """Gets the unique_hash of this MarketPlaceTemplateImport.  # noqa: E501

        unique hash to allow user to import the self-created marketplace template  # noqa: E501

        :return: The unique_hash of this MarketPlaceTemplateImport.  # noqa: E501
        :rtype: str
        """
    ...
    def unique_hash(self, unique_hash):
        """Sets the unique_hash of this MarketPlaceTemplateImport.

        unique hash to allow user to import the self-created marketplace template  # noqa: E501

        :param unique_hash: The unique_hash of this MarketPlaceTemplateImport.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MarketPlaceTemplateImport, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MarketPlaceTemplateImport):
            return False
