...
class TaskEventsPaasPaasServiceAdd(object):
    ...
    def __init__(self, labels=None, name=None, paas_security_zone_uuid=None, paas_service_uuid=None, paas_template_uuid=None, credentials=None, resource_limit=None, parameters=None):  # noqa: E501
