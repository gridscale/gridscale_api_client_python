...
class EventResponseEvents(object):
    ...
    def __init__(self, object_type=None, request_uuid=None, object_uuid=None, activity=None, request_type=None, request_status=None, change=None, timestamp=None, user_uuid=None):  # noqa: E501
    ...
    def user_uuid(self):
        ...
        The UUID of the user that triggered the event.  # noqa: E501
