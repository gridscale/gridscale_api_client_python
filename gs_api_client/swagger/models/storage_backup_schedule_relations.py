...
class StorageBackupScheduleRelations(object):
    ...
    """
    swagger_types = {
        'storages_backups': 'list[SnapshotScheduleRelationsSnapshots]'
    }

    attribute_map = {
        'storages_backups': 'storages_backups'
    }

    def __init__(self, storages_backups=None):  # noqa: E501
        """StorageBackupScheduleRelations - a model defined in Swagger"""  # noqa: E501

        self._storages_backups = None
        self.discriminator = None

        if storages_backups is not None:
            self.storages_backups = storages_backups

    @property
    def storages_backups(self):
        """Gets the storages_backups of this StorageBackupScheduleRelations.  # noqa: E501


        :return: The storages_backups of this StorageBackupScheduleRelations.  # noqa: E501
        :rtype: list[SnapshotScheduleRelationsSnapshots]
        """
        return self._storages_backups

    @storages_backups.setter
    def storages_backups(self, storages_backups):
        """Sets the storages_backups of this StorageBackupScheduleRelations.


        :param storages_backups: The storages_backups of this StorageBackupScheduleRelations.  # noqa: E501
        :type: list[SnapshotScheduleRelationsSnapshots]
        """

        self._storages_backups = storages_backups
