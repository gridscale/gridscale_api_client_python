...
class PaasServiceTemplate(object):
    ...
    def __init__(self, name=None, object_uuid=None, category=None, flavour=None, version=None, performance_class=None, version_upgrades=None, performance_class_updates=None, patch_updates=None, labels=None, product_no=None, discount_product_no=None, discount_period=None, resources=None, status=None, parameters_schema=None):  # noqa: E501
