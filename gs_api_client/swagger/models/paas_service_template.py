...
class PaasServiceTemplate(object):
    ...
    def __init__(self, name=None, object_uuid=None, category=None, labels=None, product_no=None, resources=None, status=None, parameters_schema=None):  # noqa: E501
    ...
    def category(self):
        ...
        Describes the catagory of the service.  # noqa: E501
