...
class AccessKey(object):
    ...
    def __init__(self, secret_key=None, access_key=None, user=None):  # noqa: E501
    ...
    @property
    def user(self):
        """Gets the user of this AccessKey.  # noqa: E501

        Account this credentials belong to.  # noqa: E501

        :return: The user of this AccessKey.  # noqa: E501
        :rtype: str
        """
        return self._user
    ...
    @user.setter
    def user(self, user):
        """Sets the user of this AccessKey.

        Account this credentials belong to.  # noqa: E501

        :param user: The user of this AccessKey.  # noqa: E501
        :type: str
        """
