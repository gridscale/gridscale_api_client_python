...
class StorageCreate(object):
    ...
    def template(self):
        ...
        An object holding important values such as hostnames, passwords, and SSH keys. Creating a storage with a template is required either sshkey or password. Windows template is only accepted password  # noqa: E501
