...
class StorageSnapshots(object):
    ...
    def __init__(self, object_uuid=None, storage_uuid=None, object_name=None, schedules_snapshot_uuid=None, schedules_snapshot_name=None, last_used_template=None, create_time=None):  # noqa: E501
