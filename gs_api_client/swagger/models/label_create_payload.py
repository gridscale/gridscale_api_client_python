...
class LabelCreatePayload(object):
    ...
    def __init__(self, label=None):  # noqa: E501
        """LabelCreatePayload - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def label(self):
        """Gets the label of this LabelCreatePayload.  # noqa: E501


        :return: The label of this LabelCreatePayload.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this LabelCreatePayload.


        :param label: The label of this LabelCreatePayload.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LabelCreatePayload, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LabelCreatePayload):
            return False
