...
class StorageBackupSchedule(object):
    ...
    def __init__(self, change_time=None, create_time=None, keep_backups=None, name=None, next_runtime=None, object_uuid=None, relations=None, run_interval=None, status=None, storage_uuid=None, active=None):  # noqa: E501
