...
class Location(object):
    ...
    def __init__(self, iata=None, labels=None, name=None, object_uuid=None, country=None, active=None, change_requested=None, cpunode_count=None, public=None, product_no=None):  # noqa: E501
