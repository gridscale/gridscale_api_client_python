...
class ServerCreate(object):
    ...
    def __init__(self, name=None, cores=None, memory=None, location_uuid=None, labels=None, status=None, availability_zone=None, auto_recovery=None, hardware_profile=None):  # noqa: E501
    ...
    def location_uuid(self):
        """Gets the location_uuid of this ServerCreate.  # noqa: E501

        The UUID of the datacenter you would like to hold your server. A list of available data centres can be found with a GET request on the /locations endpoint.  # noqa: E501

        :return: The location_uuid of this ServerCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def location_uuid(self, location_uuid):
        """Sets the location_uuid of this ServerCreate.

        The UUID of the datacenter you would like to hold your server. A list of available data centres can be found with a GET request on the /locations endpoint.  # noqa: E501

        :param location_uuid: The location_uuid of this ServerCreate.  # noqa: E501
        :type: str
        """
    ...
    def hardware_profile(self, hardware_profile):
        ...
        :type: str
        """
        allowed_values = ["default", "nested", "legacy", "cisco_csr", "sophos_utm", "f5_bigip", "q35", "q35_nested"]  # noqa: E501
