...
from gs_api_client.swagger.models.market_place_template_index import MarketPlaceTemplateIndex  # noqa: F401,E501


class MarketPlaceTemplatesGetResponse(object):
    ...
    """
    swagger_types = {
        'marketplace_templates': 'MarketPlaceTemplateIndex'
    }
    ...
    def __init__(self, marketplace_templates=None):  # noqa: E501
        """MarketPlaceTemplatesGetResponse - a model defined in Swagger"""  # noqa: E501

        self._marketplace_templates = None
        self.discriminator = None

        if marketplace_templates is not None:
            self.marketplace_templates = marketplace_templates

    @property
    def marketplace_templates(self):
        """Gets the marketplace_templates of this MarketPlaceTemplatesGetResponse.  # noqa: E501


        :return: The marketplace_templates of this MarketPlaceTemplatesGetResponse.  # noqa: E501
        :rtype: MarketPlaceTemplateIndex
        """
        return self._marketplace_templates

    @marketplace_templates.setter
    def marketplace_templates(self, marketplace_templates):
        """Sets the marketplace_templates of this MarketPlaceTemplatesGetResponse.


        :param marketplace_templates: The marketplace_templates of this MarketPlaceTemplatesGetResponse.  # noqa: E501
        :type: MarketPlaceTemplateIndex
        """

        self._marketplace_templates = marketplace_templates
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MarketPlaceTemplatesGetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MarketPlaceTemplatesGetResponse):
            return False
