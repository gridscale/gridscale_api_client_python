...
class LoadbalancerUpdate(object):
    ...
    def __init__(self, name=None, forwarding_rules=None, backend_servers=None, status=None, redirect_http_to_https=None, labels=None, algorithm=None, listen_ipv4_uuid=None):  # noqa: E501
