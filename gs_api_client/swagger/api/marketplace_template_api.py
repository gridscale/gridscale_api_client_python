...
class MarketplaceTemplateApi(object):
    ...
    def create_marketplace_template(self, payload, **kwargs):  # noqa: E501
        """Marketplace Template Create/Import  # noqa: E501

        https://api.gridscale.io/objects/marketplace/templates To create/import a new Marketplace template.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_marketplace_template(payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param object payload: Data for a new template (required)
        :return: MarketPlaceTemplateCreateResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_marketplace_template_with_http_info(payload, **kwargs)  # noqa: E501
        else:
            (data) = self.create_marketplace_template_with_http_info(payload, **kwargs)  # noqa: E501
            return data

    def create_marketplace_template_with_http_info(self, payload, **kwargs):  # noqa: E501
        """Marketplace Template Create/Import  # noqa: E501

        https://api.gridscale.io/objects/marketplace/templates To create/import a new Marketplace template.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_marketplace_template_with_http_info(payload, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_marketplace_template" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('payload' not in params or
            ...
            raise ValueError("Missing the required parameter `payload` when calling `create_marketplace_template`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/marketplace/templates', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='MarketPlaceTemplateCreateResponse',  # noqa: E501
    ...
    def delete_marketplace_template(self, marketplace_template_uuid, **kwargs):  # noqa: E501
        """Marketplace Template Delete  # noqa: E501

        https://api.gridscale.io/objects/marketplace/templates/{marketplace_template_uuid} To delete a Marketplace template.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_marketplace_template(marketplace_template_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str marketplace_template_uuid: object that need to be deleted. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_marketplace_template_with_http_info(marketplace_template_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_marketplace_template_with_http_info(marketplace_template_uuid, **kwargs)  # noqa: E501
            return data

    def delete_marketplace_template_with_http_info(self, marketplace_template_uuid, **kwargs):  # noqa: E501
        """Marketplace Template Delete  # noqa: E501

        https://api.gridscale.io/objects/marketplace/templates/{marketplace_template_uuid} To delete a Marketplace template.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_marketplace_template_with_http_info(marketplace_template_uuid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['marketplace_template_uuid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_marketplace_template" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'marketplace_template_uuid' is set
        if ('marketplace_template_uuid' not in params or
                params['marketplace_template_uuid'] is None):
            raise ValueError("Missing the required parameter `marketplace_template_uuid` when calling `delete_marketplace_template`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'marketplace_template_uuid' in params:
            path_params['marketplace_template_uuid'] = params['marketplace_template_uuid']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/marketplace/templates/{marketplace_template_uuid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_marketplace_template(self, marketplace_template_uuid, **kwargs):  # noqa: E501
        """Marketplace Template Get  # noqa: E501

        https://api.gridscale.io/objects/marketplace/templates/{marketplace_template_uuid} To retrieve detailed information about a specific Marketplace template.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_marketplace_template(marketplace_template_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str marketplace_template_uuid: The UUID of an object is always unique, and refers to a specific object. (required)
        :return: MarketPlaceTemplateGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_marketplace_template_with_http_info(marketplace_template_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_marketplace_template_with_http_info(marketplace_template_uuid, **kwargs)  # noqa: E501
            return data

    def get_marketplace_template_with_http_info(self, marketplace_template_uuid, **kwargs):  # noqa: E501
        """Marketplace Template Get  # noqa: E501

        https://api.gridscale.io/objects/marketplace/templates/{marketplace_template_uuid} To retrieve detailed information about a specific Marketplace template.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_marketplace_template_with_http_info(marketplace_template_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_marketplace_template" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'marketplace_template_uuid' is set
        if ('marketplace_template_uuid' not in params or
                params['marketplace_template_uuid'] is None):
            raise ValueError("Missing the required parameter `marketplace_template_uuid` when calling `get_marketplace_template`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/marketplace/templates/{marketplace_template_uuid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='MarketPlaceTemplateGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_marketplace_template_events(self, marketplace_template_uuid, **kwargs):  # noqa: E501
        """Marketplace Template Events  # noqa: E501

        https://api.gridscale.io/objects/marketplace/templates/{marketplace_template_uuid}/events To retrieve the event log of a Marketplace template.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_marketplace_template_events(marketplace_template_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str marketplace_template_uuid: uuid of marketplace template (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_marketplace_template_events_with_http_info(marketplace_template_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_marketplace_template_events_with_http_info(marketplace_template_uuid, **kwargs)  # noqa: E501
            return data

    def get_marketplace_template_events_with_http_info(self, marketplace_template_uuid, **kwargs):  # noqa: E501
        """Marketplace Template Events  # noqa: E501

        https://api.gridscale.io/objects/marketplace/templates/{marketplace_template_uuid}/events To retrieve the event log of a Marketplace template.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_marketplace_template_events_with_http_info(marketplace_template_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_marketplace_template_events" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'marketplace_template_uuid' is set
        if ('marketplace_template_uuid' not in params or
                params['marketplace_template_uuid'] is None):
            raise ValueError("Missing the required parameter `marketplace_template_uuid` when calling `get_marketplace_template_events`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/marketplace/templates/{marketplace_template_uuid}/events', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_marketplace_templates(self, **kwargs):  # noqa: E501
        """Marketplace Templates Get  # noqa: E501

        https://api.gridscale.io/objects/marketplace/templates To retrieve detailed information about all the Marketplace templates.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_marketplace_templates(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: MarketPlaceTemplatesGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_marketplace_templates_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_marketplace_templates_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_marketplace_templates_with_http_info(self, **kwargs):  # noqa: E501
        """Marketplace Templates Get  # noqa: E501

        https://api.gridscale.io/objects/marketplace/templates To retrieve detailed information about all the Marketplace templates.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_marketplace_templates_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_marketplace_templates" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/objects/marketplace/templates', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='MarketPlaceTemplatesGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_marketplace_template(self, marketplace_template_uuid, payload, **kwargs):  # noqa: E501
        """Marketplace Template Patch  # noqa: E501

        https://api.gridscale.io/objects/marketplace/templates/{marketplace_template_uuid} To update a Marketplace template.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_marketplace_template(marketplace_template_uuid, payload, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str marketplace_template_uuid: object that need to be updated.. (required)
        :param MarketPlaceTemplateUpdate payload: Updated user object. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_marketplace_template_with_http_info(marketplace_template_uuid, payload, **kwargs)  # noqa: E501
        else:
            (data) = self.update_marketplace_template_with_http_info(marketplace_template_uuid, payload, **kwargs)  # noqa: E501
            return data

    def update_marketplace_template_with_http_info(self, marketplace_template_uuid, payload, **kwargs):  # noqa: E501
        """Marketplace Template Patch  # noqa: E501

        https://api.gridscale.io/objects/marketplace/templates/{marketplace_template_uuid} To update a Marketplace template.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_marketplace_template_with_http_info(marketplace_template_uuid, payload, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['marketplace_template_uuid', 'payload']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_marketplace_template" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'marketplace_template_uuid' is set
        if ('marketplace_template_uuid' not in params or
                params['marketplace_template_uuid'] is None):
            raise ValueError("Missing the required parameter `marketplace_template_uuid` when calling `update_marketplace_template`")  # noqa: E501
        # verify the required parameter 'payload' is set
        if ('payload' not in params or
                params['payload'] is None):
            raise ValueError("Missing the required parameter `payload` when calling `update_marketplace_template`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/marketplace/templates/{marketplace_template_uuid}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
