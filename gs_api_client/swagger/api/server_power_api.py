...
class ServerPowerApi(object):
    ...
    def get_server_power(self, server_uuid, **kwargs):  # noqa: E501
        ...
        https://api.gridscale.io/objects/servers/{server_uuid}/power Returns the Servers current power status.  # noqa: E501
    ...
    def server_power_shutdown(self, server_uuid, payload, **kwargs):  # noqa: E501
        ...
        https://api.gridscale.io/objects/servers/{server_uuid}/shutdown turn on and off a server via ACPI.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
