...
class LocationApi(object):
    ...
    def get_location(self, location_uuid, **kwargs):  # noqa: E501
        ...
        https://api.gridscale.io/objects/locations/{location_uuid} To retrieve detailed information about a specific location.  # noqa: E501
    ...
    def get_location_ips(self, location_uuid, **kwargs):  # noqa: E501
        """Location IPs Get  # noqa: E501

        https://api.gridscale.io/objects/locations/{location_uuid}/ips To retrieve detailed information about IPs for a specific location.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_location_ips(location_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str location_uuid: uuid of location (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_location_ips_with_http_info(location_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_location_ips_with_http_info(location_uuid, **kwargs)  # noqa: E501
            return data

    def get_location_ips_with_http_info(self, location_uuid, **kwargs):  # noqa: E501
        """Location IPs Get  # noqa: E501

        https://api.gridscale.io/objects/locations/{location_uuid}/ips To retrieve detailed information about IPs for a specific location.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_location_ips_with_http_info(location_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_location_ips" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'location_uuid' is set
        if ('location_uuid' not in params or
                params['location_uuid'] is None):
            raise ValueError("Missing the required parameter `location_uuid` when calling `get_location_ips`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/locations/{location_uuid}/ips', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_location_isoimages(self, location_uuid, **kwargs):  # noqa: E501
        """Location ISO Images Get  # noqa: E501

        https://api.gridscale.io/objects/locations/{location_uuid}/isoimages To retrieve detailed information about the ISO images for a specific location.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_location_isoimages(location_uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_location_isoimages_with_http_info(location_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_location_isoimages_with_http_info(location_uuid, **kwargs)  # noqa: E501
            return data

    def get_location_isoimages_with_http_info(self, location_uuid, **kwargs):  # noqa: E501
        """Location ISO Images Get  # noqa: E501

        https://api.gridscale.io/objects/locations/{location_uuid}/isoimages To retrieve detailed information about the ISO images for a specific location.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_location_isoimages_with_http_info(location_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_location_isoimages" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'location_uuid' is set
        if ('location_uuid' not in params or
                params['location_uuid'] is None):
            raise ValueError("Missing the required parameter `location_uuid` when calling `get_location_isoimages`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/locations/{location_uuid}/isoimages', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_location_networks(self, location_uuid, **kwargs):  # noqa: E501
        """Location Networks Get  # noqa: E501

        https://api.gridscale.io/objects/locations/{location_uuid}/networks To retrieve detailed information about the networks for a specific location.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_location_networks(location_uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_location_networks_with_http_info(location_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_location_networks_with_http_info(location_uuid, **kwargs)  # noqa: E501
            return data

    def get_location_networks_with_http_info(self, location_uuid, **kwargs):  # noqa: E501
        """Location Networks Get  # noqa: E501

        https://api.gridscale.io/objects/locations/{location_uuid}/networks To retrieve detailed information about the networks for a specific location.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_location_networks_with_http_info(location_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_location_networks" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'location_uuid' is set
        if ('location_uuid' not in params or
                params['location_uuid'] is None):
            raise ValueError("Missing the required parameter `location_uuid` when calling `get_location_networks`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/locations/{location_uuid}/networks', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_location_servers(self, location_uuid, **kwargs):  # noqa: E501
        """Location Servers Get  # noqa: E501

        https://api.gridscale.io/objects/locations/{location_uuid}/servers To retrieve detailed information about servers for a specific location.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_location_servers(location_uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_location_servers_with_http_info(location_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_location_servers_with_http_info(location_uuid, **kwargs)  # noqa: E501
            return data

    def get_location_servers_with_http_info(self, location_uuid, **kwargs):  # noqa: E501
        """Location Servers Get  # noqa: E501

        https://api.gridscale.io/objects/locations/{location_uuid}/servers To retrieve detailed information about servers for a specific location.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_location_servers_with_http_info(location_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_location_servers" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'location_uuid' is set
        if ('location_uuid' not in params or
                params['location_uuid'] is None):
            raise ValueError("Missing the required parameter `location_uuid` when calling `get_location_servers`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/locations/{location_uuid}/servers', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_location_snapshots(self, location_uuid, **kwargs):  # noqa: E501
        """Location Snapshots Get  # noqa: E501

        https://api.gridscale.io/objects/locations/{location_uuid}/snapshots To retrieve detailed information about the snapshots for a specific location.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_location_snapshots(location_uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_location_snapshots_with_http_info(location_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_location_snapshots_with_http_info(location_uuid, **kwargs)  # noqa: E501
            return data

    def get_location_snapshots_with_http_info(self, location_uuid, **kwargs):  # noqa: E501
        """Location Snapshots Get  # noqa: E501

        https://api.gridscale.io/objects/locations/{location_uuid}/snapshots To retrieve detailed information about the snapshots for a specific location.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_location_snapshots_with_http_info(location_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_location_snapshots" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'location_uuid' is set
        if ('location_uuid' not in params or
                params['location_uuid'] is None):
            raise ValueError("Missing the required parameter `location_uuid` when calling `get_location_snapshots`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/locations/{location_uuid}/snapshots', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_location_storages(self, location_uuid, **kwargs):  # noqa: E501
        """Location Storages Get  # noqa: E501

        https://api.gridscale.io/objects/locations/{location_uuid}/storages To retrieve detailed information about storages for a specific location.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_location_storages(location_uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_location_storages_with_http_info(location_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_location_storages_with_http_info(location_uuid, **kwargs)  # noqa: E501
            return data

    def get_location_storages_with_http_info(self, location_uuid, **kwargs):  # noqa: E501
        """Location Storages Get  # noqa: E501

        https://api.gridscale.io/objects/locations/{location_uuid}/storages To retrieve detailed information about storages for a specific location.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_location_storages_with_http_info(location_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_location_storages" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'location_uuid' is set
        if ('location_uuid' not in params or
                params['location_uuid'] is None):
            raise ValueError("Missing the required parameter `location_uuid` when calling `get_location_storages`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/locations/{location_uuid}/storages', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_location_templates(self, location_uuid, **kwargs):  # noqa: E501
        """Location Templates Get  # noqa: E501

        https://api.gridscale.io/objects/locations/{location_uuid}/templates To retrieve detailed information about templates for a specific location.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_location_templates(location_uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_location_templates_with_http_info(location_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_location_templates_with_http_info(location_uuid, **kwargs)  # noqa: E501
            return data

    def get_location_templates_with_http_info(self, location_uuid, **kwargs):  # noqa: E501
        """Location Templates Get  # noqa: E501

        https://api.gridscale.io/objects/locations/{location_uuid}/templates To retrieve detailed information about templates for a specific location.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_location_templates_with_http_info(location_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_location_templates" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'location_uuid' is set
        if ('location_uuid' not in params or
                params['location_uuid'] is None):
            raise ValueError("Missing the required parameter `location_uuid` when calling `get_location_templates`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/objects/locations/{location_uuid}/templates', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
