...
class NetworkApi(object):
    ...
    def delete_network_pinned_server(self, network_uuid, server_uuid, **kwargs):  # noqa: E501
        """Un-pinned a server  # noqa: E501

        https://api.gridscale.io/objects/networks/{network_uuid}/pinned_servers/{server_uuid} Removing DHCP IP from a server  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update_network_pinned_server(self, network_uuid, server_uuid, payload, **kwargs):  # noqa: E501
        """Pinned a server  # noqa: E501

        https://api.gridscale.io/objects/networks/{network_uuid}/pinned_servers/{server_uuid} Assigning DHCP IP into a server  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param str network_uuid: ID of storage (required)
        :param str server_uuid: ID of storage (required)
        :param PinnedServerPayload payload: Pinned servers (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
