...
from gs_api_client.swagger.configuration import Configuration
import gs_api_client.swagger.models
from gs_api_client.swagger import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(gs_api_client.swagger.models, klass)
